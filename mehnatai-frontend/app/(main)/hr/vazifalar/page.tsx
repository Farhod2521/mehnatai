...
function TaskCard({ task, onApprove, approving }: {
  ...
  return (
    <div style={{
      ...
      border: "1.5px solid #E5E7EB", display: "flex", alignItems: "flex-start",
      ...
      <div style={{ flex: 1, minWidth: 0 }}>
        <div style={{ display: "flex", flexWrap: "wrap", alignItems: "center", gap: "8px", marginBottom: "6px" }}>
          ...
          <span style={{ fontSize: "11px", fontWeight: 600, padding: "2px 10px", borderRadius: "20px", background: p.bg, color: p.color }}>
            {p.label}
          </span>
        </div>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: "12px", alignItems: "center" }}>
          ...
          <Link
            ...
            style={{ fontSize: "12px", color: "#6366F1", fontWeight: 600, textDecoration: "none", display: "flex", alignItems: "center", gap: "4px" }}
          >
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
        <div>
          ...
          <p style={{ fontSize: "13px", color: "#6B7280" }}>
            Xodimlar tomonidan bajarilgan deb belgilangan vazifalar HR tasdig'ini kutmoqda
          </p>
        </div>
        <button
          onClick={loadTasks}
      ...
      {loading ? (
        ...
        <div style={{ background: "white", borderRadius: "24px", padding: "80px 40px", textAlign: "center", border: "1px solid #E5E7EB" }}>
          ...
          <h3 style={{ fontSize: "18px", fontWeight: 700, color: "#111827", marginBottom: "8px" }}>
            Barcha vazifalar tasdiqlangan!
          </h3>
          <p style={{ fontSize: "14px", color: "#9CA3AF" }}>
            Hozircha HR tasdig'ini kutayotgan vazifalar yo'q
          </p>
        </div>
      ) : (
        <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
