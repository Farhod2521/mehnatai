...
export default function Landing() {
  ...
  return (
    <div style={{ fontFamily: "'Inter',sans-serif", background: "#F5F8F7", color: "#111827", overflowX: "hidden" }}>
      ...
      <nav style={{
        ...
        <div style={{ display: "flex", gap: "32px" }}>
          {["Platforma", "AI Algoritmlar", "Narxlar", "Haqida"].map(l => (
            <a key={l} href="#" style={{ fontSize: "13.5px", fontWeight: 500, color: "#6B8A82", textDecoration: "none", transition: "color 0.2s" }}
        ...
        <div style={{ display: "flex", gap: "8px", alignItems: "center" }}>
          <Link href="/login" style={{
            ...
            border: "1px solid #D4EAE4", background: "transparent",
            transition: "all 0.2s",
          }}
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "60px", alignItems: "center" }}>
            ...
            <div>
              ...
              <div style={{ display: "flex", gap: "12px", alignItems: "center" }}>
                <Link href="/login" style={{
                  ...
                  boxShadow: "0 8px 28px rgba(0,184,148,0.35)",
                ...
                <Link href="/login" style={{
                  ...
                  border: "1.5px solid #D4EAE4",
                  transition: "all 0.2s",
                  boxShadow: "0 2px 8px rgba(0,0,0,0.06)",
                }}
                  onMouseEnter={e => { (e.currentTarget as HTMLAnchorElement).style.borderColor = "#00B894"; (e.currentTarget as HTMLAnchorElement).style.color = "#00B894"; (e.currentTarget as HTMLAnchorElement).style.boxShadow = "0 4px 16px rgba(0,184,148,0.15)"; }}
                  onMouseLeave={e => { (e.currentTarget as HTMLAnchorElement).style.borderColor = "#D4EAE4"; (e.currentTarget as HTMLAnchorElement).style.color = "#4A7A6D"; (e.currentTarget as HTMLAnchorElement).style.boxShadow = "0 2px 8px rgba(0,0,0,0.06)"; }}
                >
            ...
            <div style={{ position: "relative" }}>
              ...
              <div style={{
                ...
                boxShadow: "0 20px 60px rgba(0,0,0,0.1), 0 4px 16px rgba(0,184,148,0.08)",
                overflow: "hidden",
              }}>
                {/* Window bar */}
                <div style={{ padding: "12px 16px", background: "#F8FAF9", borderBottom: "1px solid #EBF2EE", display: "flex", alignItems: "center", gap: "6px" }}>
                  ...
                  <div style={{ flex: 1, display: "flex", justifyContent: "center" }}>
                    <div style={{ padding: "3px 16px", borderRadius: "6px", background: "#EBF2EE", fontSize: "10px", color: "#9DB5AE" }}>mehnatai.uz/dashboard</div>
                  </div>
                </div>
              ...
              {/* Floating AI card */}
              <div style={{
                position: "absolute", bottom: "-20px", left: "-28px", zIndex: 2,
                padding: "14px 16px", borderRadius: "16px",
                background: "white", border: "1.5px solid #D4EAE4",
                ...
                <p style={{ fontSize: "11px", color: "#5A7A72", lineHeight: 1.5 }}>
                  Azizbek: +12% o'sish bashorat qilinmoqda.
                </p>
              </div>
              ...
              <div style={{
                ...
                background: "white", border: "1.5px solid #E8F0EE",
        ...
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(5,1fr)", gap: "14px" }}>
            {[
              ...
              <div key={num} style={{ padding: "24px 18px", borderRadius: "18px", background: "#FFF5F5", border: "1.5px solid #FEE2E2", transition: "all 0.25s", cursor: "default" }}
                onMouseEnter={e => { (e.currentTarget as HTMLDivElement).style.transform = "translateY(-4px)"; (e.currentTarget as HTMLDivElement).style.boxShadow = "0 12px 32px rgba(248,113,113,0.15)"; (e.currentTarget as HTMLDivElement).style.borderColor = "#FECACA"; }}
                onMouseLeave={e => { (e.currentTarget as HTMLDivElement).style.transform = "translateY(0)"; (e.currentTarget as HTMLDivElement).style.boxShadow = "none"; (e.currentTarget as HTMLDivElement).style.borderColor = "#FEE2E2"; }}
              >
          ...
          <div style={{ textAlign: "center", marginTop: "56px" }}>
            <div style={{ display: "inline-flex", flexDirection: "column", alignItems: "center", gap: "6px" }}>
              ...
              <div style={{ width: "1px", height: "36px", background: "linear-gradient(180deg,#00B894,transparent)" }} />
            </div>
          </div>
        </div>
      </section>
      ...
      {/* ═══════════ USI FORMULA ═══════════ */}
      <section style={{ padding: "100px 48px", background: "#F5F8F7" }}>
      ...
      {/* ═══════════ TECH STACK ═══════════ */}
      <section style={{ padding: "56px 48px", background: "white", borderTop: "1px solid #E5EDE9" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto", textAlign: "center" }}>
          ...
          <div style={{ display: "flex", justifyContent: "center", gap: "8px", flexWrap: "wrap" }}>
            {["Django REST","PostgreSQL","Celery","React + TypeScript","Redux Toolkit","React Query","LSTM/Keras","K-Means/sklearn","mBERT NLP","JWT Auth","Docker","Next.js","Locust Tests","Playwright E2E"].map(t => (
              <span key={t} style={{ padding: "7px 15px", borderRadius: "999px", background: "#F5F8F7", border: "1.5px solid #E5EDE9", fontSize: "12px", fontWeight: 600, color: "#6B8A82", transition: "all 0.2s", cursor: "default" }}
                ...
                onMouseLeave={e => { (e.currentTarget as HTMLSpanElement).style.color = "#6B8A82"; (e.currentTarget as HTMLSpanElement).style.borderColor = "#E5EDE9"; (e.currentTarget as HTMLSpanElement).style.background = "#F5F8F7"; }}
              >{t}</span>
            ))}
          </div>
        </div>
      ...
      {/* ═══════════ FOOTER ═══════════ */}
      <footer style={{ borderTop: "1px solid #E5EDE9", padding: "36px 48px", background: "#F5F8F7" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "16px" }}>
          ...
          <div style={{ display: "flex", gap: "24px" }}>
            {["Foydalanish shartlari","Maxfiylik siyosati","Bog'lanish","API Docs"].map(l => (
              <a key={l} href="#" style={{ fontSize: "13px", color: "#9DB5AE", textDecoration: "none", transition: "color 0.15s" }}
                onMouseEnter={e => (e.currentTarget.style.color = "#00B894")}
                onMouseLeave={e => (e.currentTarget.style.color = "#9DB5AE")}
              >{l}</a>
            ))}
          </div>
          <p style={{ fontSize: "12px", color: "#B0C9C2" }}>© 2024 MehnatAI. Barcha huquqlar himoyalangan.</p>
        </div>
      </footer>
